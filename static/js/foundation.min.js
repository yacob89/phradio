...
!(function (t, e, i, s) {
  ...
  var r = function (e, s) {
    ...
    c = function (e, i) {
      ...
      return (
        r(this.scope).is("[" + this.attr_name() + "]")
          ? n.call(this.scope)
          : r("[" + this.attr_name() + "]", this.scope).each(n),
      ...
      equalize: function (e) {
        ...
        if (
          ((i = e.find(
            o.act_on_hidden_el
              ? a
                ? "[" + this.attr_name() + '-watch="' + a + '"]'
                : "[" + this.attr_name() + "-watch]"
              : a
              ? "[" + this.attr_name() + '-watch="' + a + '"]:visible'
        ...
        n(this.scope)
          ...
          .on(
            ...
            function (e) {
              ...
              (!i.is_hover || Modernizr.touch) &&
                (e.preventDefault(),
                n(this).parent("[data-reveal-id]").length &&
                  e.stopPropagation(),
                s.toggle(t(this)));
            }
          )
          ...
          .on("click.fndtn.dropdown", function (e) {
            ...
            return (
              o.length > 0 &&
                "false" !== a.attr("aria-autoclose") &&
                s.close.call(s, n("[" + s.attr_name() + "-content]")),
              (e.target !== i && !t.contains(i.documentElement, e.target)) ||
              n(e.target).closest("[" + s.attr_name() + "]").length > 0
                ? void 0
                : !n(e.target).data("revealId") &&
                  a.length > 0 &&
                  (n(e.target).is("[" + s.attr_name() + "-content]") ||
                    t.contains(a.first()[0], e.target))
        ...
        _base: function (t, s) {
          ...
          if (!this.hasClass("mega") && !s.ignore_repositioning) {
            ...
            t.offset().top <= this.outerHeight() &&
              ((o.missTop = !0), (c = l - d), (o.leftRightFlag = !0)),
              u + h > u + d &&
                u - d > h &&
                ((o.missRight = !0), (o.missLeft = !1)),
              0 >= u - h && ((o.missLeft = !0), (o.missRight = !1));
          }
          return o;
        },
        top: function (t, e) {
        ...
        (g.slides = function () {
          ...
          (g._goto = function (e, i) {
            ...
            var l = function () {
              ...
              _.outerHeight() != r.outerHeight() && a.variable_height
                ? _.animate({ height: r.outerHeight() }, 250, "linear", t)
                : t();
            };
            ...
            r.outerHeight() > _.outerHeight() && a.variable_height
              ? _.animate({ height: r.outerHeight() }, 250, "linear", d)
              : d();
          }),
          (g.next = function (t) {
    ...
    Foundation.libs.reveal = {
      ...
      open: function (i, n) {
        ...
        if (!o.hasClass("open")) {
          ...
          "undefined" == typeof o.data("css-top") &&
            o
        ...
        var t = this,
          ...
          s = function (e, s) {
            ...
            if (!n.is_hover || Modernizr.touch) {
              ...
              9 !== a && (e.preventDefault(), e.stopPropagation()),
    ...
    Foundation.libs.abide = {
      ...
      reset: function (e) {
        ...
        e.removeAttr(i.invalid_attr),
          ...
          t("." + i.settings.error_class, e)
            .not("small")
            .removeClass(i.settings.error_class),
          t(":input", e)
            .not(":button, :submit, :reset, :hidden, [data-abide-ignore]")
            .val("")
            .removeAttr(i.invalid_attr);
      },
    ...
    Foundation.libs.tooltip = {
        ...
        n.create(this.S(e)),
          t(this.scope)
            ...
            .on(
              ...
              "[" + this.attr_name() + "].open",
              function (e) {
                return /mouse/i.test(e.type) && n.ie_touch(e)
                  ? !1
                  : void (
      ...
      reposition: function (e, i, s) {
        ...
        var d = e.offset().top,
          c = e.offset().left,
          h = e.outerHeight();
        if ((l(i, d + h + 10, "auto", "auto", c), this.small()))
          l(i, d + h + 10, "auto", "auto", 12.5, t(this.scope).width()),
            i.addClass("tip-override"),
            l(a, -o, "auto", "auto", c);
        else {
          Foundation.rtl &&
            (a.addClass("rtl"), (c = c + e.outerWidth() - i.outerWidth())),
          ...
          s && s.indexOf("tip-top") > -1
            ? (Foundation.rtl && a.addClass("rtl"),
              l(i, d - u, "auto", "auto", c).removeClass("tip-override"))
